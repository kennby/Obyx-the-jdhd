...
const handler = async (m, { conn, usedPrefix }) => {
 ...
 ▢ *ModeJadiBot:* ${modejadibot ? "activado" : "desactivado"}`.trim();
  ...
  const Message = {
    document: { url: `https://github.com/kennnn/onyx-Bot-MD` },
    ...
    contextInfo: {
      ...
      isForwarded: true,
      externalAdReply: {
        mediaUrl: "https://github.com/kennnn/onyx-Bot-MD",
        mediaType: 2,
        previewType: "pdf",
        title: "The onyx - Bot",
        body: "Repositorio - GitHub",
        thumbnail: imagen1,
        sourceUrl: "https://github.com/kennnn/onyx-Bot-MD",
      },
    },
    caption: info,
    footer: wm,
