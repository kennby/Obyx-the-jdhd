...
const handler = async (m, {conn, text, args, usedPrefix, command}) => {
  ...
  try {
    ...
    const prep = generateWAMessageFromContent(m.chat, {extendedTextMessage: {text: texto, contextInfo: {externalAdReply: {title: 'ONYX', body: null, thumbnail: imagen1, sourceUrl: 'https://github.com/onyxxxx-MD'}, mentionedJid: [m.sender]}}}, aa);
